        ...
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel category-carousel owl-theme">
                  ...
                  <div class="item">
                    <a class="text-decoration-none" href="{{url('/blog/'.$all_cate_item->slug)}}">
                        <div class="card">
            ...
            <div class="col-md-8">
                @foreach ($latest_posts as $latest_post_item)
                    ...
                    <div class="card card-body mb-3 bg-gray shadow">
                        <a class="text-dark text-decoration-none" href="{{url('/blog/'.$latest_post_item->category->slug.'/'.$latest_post_item->slug)}}" class="text-decoration-none">
